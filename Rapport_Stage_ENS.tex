...
%		\begin{subfigure}[b]{0.5\linewidth}
%			\centering
%			\includegraphics[width = 0.9 \linewidth]{Images/PV/HMM/id175.pdf}
...
%		\begin{subfigure}[b]{0.5\linewidth}
%			\centering
%			\includegraphics[width = 0.9 \linewidth]{Images/PV/HMM/id187.pdf}
%			\caption{25-27 Juin 2017}
%			%\vspace{4ex}
%		\end{subfigure}%%
%		\begin{subfigure}[b]{0.5\linewidth}
...
%		\begin{subfigure}[b]{0.5\linewidth}
%			\centering
%			\includegraphics[width = 0.9 \linewidth]{Images/PV/HMM/id27.pdf}
%			\caption{25-27 Juin 2017}
%			%\vspace{4ex}
%		\end{subfigure}%%
%		\begin{subfigure}[b]{0.5\linewidth}
...
%	\end{center}
%	
%	\caption{Génération de 100 scénarios à partir d'initialisations différentes matérialisées par un fond coloré. Les différents scénarios sont en violet, leur moyenne en rose, leur intervalle de prévision à $90\%$ en vert et enfin la série originale en orange. A gauche les scénarios ont été générés par le HMM de la section \ref{sec:PV_HMM} et à droite par un SARIMA (1,0,1)(1,1,0)[24]}
%	\label{fig:PV_SARIMA_HMM_Scenarios} 
%\end{figure}
...
Afin de caractériser ces ensembles de prédictions, \cite{madsen_protocol_nodate} préconise l'utilisation d'au moins trois critères, à savoir la MAE (\ref{subsec:Model_Metric_MAE}), l'erreur quadratique (\ref{subsec:Model_Metric_RMSE}) et l'erreur moyenne (\ref{subsec:Model_Metric_BIAS}). Les résultats obtenus sur ces métriques et par scénario sont présentés dans le tableau \ref{tab:PV_Metrics}. Comme ces valeurs ne sont pas très explicites en elles mêmes, il est plus simple de les comparer. Il a été choisi ici de les comparer aux résultats obtenus par un modèle classique de traitement de série temporelle : un Seasonal Auto Regressive Integrated Moving Average (SARIMA). Le choix des paramètres du modèle -- l'ordre auto régressif, l'ordre de différenciation et l'ordre de la moyenne mobile ainsi que leurs homologues correspondant aux termes saisonniers -- sont choisis par le critère BIC. Les coefficients du modèle SARIMA obtenu sont présentés dans le tableau
...
\begin{figure}[htbp]
 	\begin{center}
 		...
 		\begin{subfigure}[b]{0.5\linewidth}
 			\centering
 			\includegraphics[width = 0.95 \linewidth]{Images/PV/SARIMA/175.pdf}
 			\caption{25-27 Juin 2017}
 			%\vspace{4ex}
 		\end{subfigure}%%
 		\begin{subfigure}[b]{0.5\linewidth}
 			\centering
 			\includegraphics[width = 0.95 \linewidth]{Images/PV/SARIMA/187.pdf}
 			\caption{7-9 Juillet 2017}
 			%\vspace{4ex}
 		\end{subfigure}
 		...
 		\begin{subfigure}[b]{0.5\linewidth}
 			\centering
 			\includegraphics[width = 0.95 \linewidth]{Images/PV/SARIMA/27.pdf}
 			\caption{27-29 Janvier 2017}
 			%\vspace{4ex}
 		\end{subfigure}%%
 		\begin{subfigure}[b]{0.5\linewidth}
 			\centering
 			\includegraphics[width = 0.95 \linewidth]{Images/PV/SARIMA/41.pdf}
 			\caption{10-12 février 2017}
 			%\vspace{4ex}
 		\end{subfigure}
 	\end{center}
