...
\begin{titlepage}
	\begin{center}
		...
		\\ \vspace{1cm}
		\includegraphics[height=3cm]{Images/logos/logo_SATIE.jpg} \hfill %\includegraphics[height=2cm]{Imageslogos/logo_ur1.jpg} \hfill ~
		\\ \vfill
...
\nomenclature{AR}{Processus auto-régressif}
\nomenclature{MA}{Processus moyenne mobile}
%\nomenclature{ARMA}{Modèles autorégressifs et moyenne mobile}
\nomenclature{SARMA}{ARMA saisonnier}
\nomenclature{$a_1,\cdots,a_p$}{$p$ paramètre(s) d'un processus auto-régressif}
\nomenclature{$b_1,\cdots,b_p$}{$q$ paramètre(s) d'un processus moyenne mobile}
\nomenclature{$A_1,\cdots,A_p$}{$P$ paramètre(s) d'un processus auto-régressif saisonnier}
\nomenclature{$B_1,\cdots,B_p$}{$Q$ paramètre(s) d'un processus moyenne mobile saisonnier}
